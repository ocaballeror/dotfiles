...
# Git options that are not supported in its own config file
...
export PYSTDDEPS="black ptpython debugpy pdbpp pynvim ruff python-lsp-server python-lsp-ruff pylsp-mypy -e ~/Stuff/autoimport"
