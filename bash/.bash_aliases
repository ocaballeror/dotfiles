...
alias errcho='>&2 echo'
alias feh='feh -d.'
alias ffmpeg='ffmpeg -hide_banner -protocol_whitelist https,http,file,tls,tcp'
alias ffprobe='ffprobe -hide_banner -protocol_whitelist https,http,file,tls,tcp'
alias ffplay='ffplay -hide_banner -protocol_whitelist https,http,file,tls,tcp'
alias fhg='fg'
...
alias gti='git'
alias qgit='git'
alias grep='grep --color=auto -I --exclude-dir={.tox,.git,.ipynb_checkpoints,.venv} --exclude=.tags'
alias grpe='grep'
alias gz='gzip'
alias gzd='gzip -d'
alias hask='ghci'
...
alias kl='kubectl logs -f --tail 300'
...
alias pccs='git push && sleep 5 && ccs'
alias pcr='pre-commit run --all'
alias pkill='pkill -e'
...
alias venv='rm -rf .venv && virtualenv .venv && source .venv/bin/activate && pip install $PYSTDDEPS && { [ ! -f requirements.txt ] || pip install -r requirements.txt; }'
alias vi='vim'
alias vimm='vim'
alias vmi='vim'
