...
alias errcho='>&2 echo'
alias firefox='firefox --private-window >/dev/null 2>&1 &'
alias fucking='sudo'
...
alias sshrasp='ssh pi@192.168.2.124 || ssh pi@192.168.1.121 || ssh pi@192.168.1.120'
...
alias vim=' [ -f .vimsession ] && vim --servername "$(date "+%d-%m-%Y %H:%M:%S")" -S .vimsession || vim --servername "$(date "+%d-%m-%Y %H:%M:%S")"'
...
alias whatsapp='cd ~; virtualbox --startvm Android & >/dev/null 2>&1; unalias firefox; firefox web.whatsapp.com & >/dev/null 2>&1; cd -'
