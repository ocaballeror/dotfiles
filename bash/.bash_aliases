...
alias condalibs='cd $(conda info | grep "active env location" | cut -d: -f2-)/lib/python3.8/site-packages'
alias cp='cp -v'
...
alias pppw='ppw'
alias ppu='pipenv --rm; pipenv install --dev && pipenv run pip install ptpython pytest-watch flake8 pynvim python-lsp-server black pylsp-mypy'
alias ppw='pipenv run ptw -n -- -vv --sw'
...
alias venv='rm -rf .venv && virtualenv .venv && source .venv/bin/activate && pip install ptpython pytest-watch flake8 pynvim python-lsp-server black pylsp-mypy && { [ ! -f requirements.txt ] || pip install -r requirements.txt; }'
alias venvlibs='cd $(which python 2>/dev/null | rev | cut -d/ -f3- |rev)/lib/python*/site-packages'
alias vi='vim'
alias vimm='vim'
alias vmi='vim'
